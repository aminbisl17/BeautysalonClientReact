...
function LoginView() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch(process.env.REACT_APP_CLIENT_LOGIN, {
        method: "POST",
  ...
  const sendVerificationCode = async (targetEmail) => {
    ...
    try {
      const res = await fetch(process.env.REACT_APP_CLIENT_SEND_EMAIL_VERIFICATION, {
        method: "POST",
        headers: {
  ...
  const verifyEmailCode = async () => {
    const token = sessionStorage.getItem("accessToken");
    try {
      const res = await fetch(process.env.REACT_APP_CLIENT_VERIFY_EMAIL, {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const handleVerify = async (code) => {
    setError("");
    try {
      const res = await fetch(process.env.REACT_APP_CLIENT_REGISTER_VERIFY, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          otpcode: code,
  ...
  const handleLogout = async () => {
    ...
    try {
      await fetch(process.env.REACT_APP_CLIENT_LOGOUT, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
      });
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      const res = await fetch(process.env.REACT_APP_CLIENT_REGISTER, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleAutoVerify = async (code) => {
    setError("");
    try {
      const res = await fetch(process.env.REACT_APP_CLIENT_LOGIN_VERIFY, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch(process.env.REACT_APP_CLIENT_UPDATE, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
